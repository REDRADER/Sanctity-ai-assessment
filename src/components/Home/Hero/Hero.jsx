...
const Hero = () => {
    ...
    return (
        <div ref={secRef} tr-scrollflip-element="component" tr-scrollflip-staggerdirection="start" className='relative w-full ' >
            <section tr-scrollflip-scrubstart="top top" className='relative h-[100vh] p-[5em_1em_1em] w-full overflow-x-hidden' >
                ...
                <div className='z-[2] h-[100vh] p-[5em_1em_1em]  absolute inset-0 flex justify-centeritems-center'>
                    <div className='bg-[--backgound-hero] w-full h-full rounded-[24px] relative ' style={{ filter: "blur(0px)" }}>
                        <Image src={"/svgs/hero_cut.svg"} width={100} height={100} className='w-[6em] h-[6em] absolute bottom-[-1px] right-[-1px] z-[4] hidden md:block' alt='hero edge cut' />

                        <img src={"/svgs/hero_cut_mobile.svg"} className=' h-[5em] absolute top-[20%] bottom-[auto] right-[-1px] z-[4] block md:hidden' alt='hero edge cut' />
                    </div>
                </div>
                <div className='z-[3] w-full h-full relative flex justify-start  md:justify-center items-end  md:items-center pb-[2em] md:pb-0 ' >
                    <div className='px-[1em] lg:px-[2em] flex gap-5 md:gap-2 items-center flex-col w-full'>

                        <span className=' text-2xl md:text-xl opacity-40 text-[#dcefd8]'>
                            Competitive Edge through Creativity & Technology
                        </span>
                        <div className='text-5xl md:text-[7.2rem] leading-[1] font-medium flex-col flex gap-3 w-full md:w-auto justify-start md:justify-center items-start md:items-center'>
                            ...
                            <div className='flex md:w-full gap-2 md:gap-8 md:pl-[2em]'>
                                ...
                                <div tr-scrollflip-element="origin" data-flip-id="make" className='text-[--accent-green] opacity-0 '>
                                    Make a
                                </div>
                            </div>
                            <div tr-scrollflip-element="origin" data-flip-id="differnce" className=' pr-[2em] text-[--accent-green] opacity-0 '>
                                Difference
                            </div>
                        </div>
                    </div>
            ...
            <section tr-scrollflip-scrubend="40% center" className='relative  p-[1em_1em] z-[2] w-full ' >
                <div className='relative z-[5] py-[2rem] md:py-[5em] h-full'>
                    <div className='w-full h-full  relative mx-[auto] max-w-[--max-width]'>
                        <div className='hidden md:block py-[3rem]' />
                        <div className='hidden md:block py-[3rem]' />


                        <div className='text-5xl md:text-[7.2rem] leading-[1] flex flex-col font-medium'>
                            <span tr-scrollflip-element="target" data-flip-id="make" className='text-[--accent-green]'> Make a </span>
                            <span tr-scrollflip-element="target" data-flip-id="differnce" className='text-[--accent-green]' >Difference </span>
                        </div>
