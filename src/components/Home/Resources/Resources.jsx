            ...
            <div className='  bg-[#fff] rounded-[24px] flex flex-col gap-4 relative p-0 md:p-[1em] '>
                <div className='w-full max-w-[--max-width] py-[2em] md:py-[5em] mx-auto flex flex-col gap-8 p-[1em] md:p-0'>
                    <div className='flex items-center w-full justify-between'>
                        ...
                        <h2 className='text-[--darkest-text] text-[1.6em] md:text-[2.4em] lg:text-[4.2em] font-semibold'>
                            Our latest resources
                        </h2>
                        <Link href='/' className='w-[2em] md:w-[2.5em] lg:w-[3.6em] h-[2em] md:h-[2.5em] lg:h-[3.6em] rounded-[50%] overflow-hidden relative bg-[#e4ece3] group '>
                            <div className='w-[2em] md:w-[2.5em] lg:w-[3.6em] h-[2em] md:h-[2.5em] lg:h-[3.6em] rounded-[50%] bg-[--background] absolute inset-0 left-[-100%] group-hover:left-[0]  duration-300 ease-in-out'>
                            </div>
                ...
                <div className='rounded-[24px] md:rounded-[16px] bg-[#97d28b66] p-[1em_1em] md:p-[2.4em_2em_0.8em] w-full'>
