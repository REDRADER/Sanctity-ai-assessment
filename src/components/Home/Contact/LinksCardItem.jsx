...
const LinksCardItem = ({ data }) => {
    return (
        ...
        <Link href={data.link} className='group w-full rounded-[24px] h-full min-h-[11rem] p-[1em] md:p-[1.8em] bg-[#000]/[20%] flex justify-between flex-col  ' style={{ backdropFilter: "blur(7px)", WebkitBackdropFilter: "blur(7.1px)" }}>
            ...
            <div className='group w-full h-[2.5em] pl-[5px] bg-none text-start font-medium text-[1.2em] md:text-[2.2em] text-[--light-text]'>
