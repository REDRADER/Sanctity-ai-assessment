...
const LinksCardItem = ({ data }) => {
    return (
        ...
        <Link href={data.link} className='group w-full rounded-[24px] h-full min-h-[10em] md:min-h-[15em]  p-[1em] md:p-[1.2em] lg:p-[1.8em] bg-[#000]/[20%] flex justify-between flex-col  ' style={{ backdropFilter: "blur(7px)", WebkitBackdropFilter: "blur(7.1px)" }}>
