    ...
    return (
        <section className='relative  p-[0.5em] md:p-[1em_1em] z-[5] w-full flex flex-col gap-5'  >
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-5 '>
                <div className='grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-5 order-2 md:order-1'>
            ...
            <footer className='group w-full h-full rounded-[24px]  p-[1em] md:p-[2em] bg-[#000]/[20%] flex justify-between flex-col gap-5  ' style={{ backdropFilter: "blur(7px)", WebkitBackdropFilter: "blur(7.1px)" }}>
                ...
                <div className='flex gap-5 flex-col'>
                    <div className='flex w-full items-center justify-between '>
                        <div className='w-full flex items-start md:items-center flex-col md:flex-row gap-3 md:gap-0'>

                            <StepText link={"/"} className=" text-[1.2em] md:text-[1.3em] text-[#dcefd8]/[60%] " >Services</StepText>
                            <span className='w-[2em] text-[#dcefd8]/[30%] hidden md:block text-center text-[1.2em] md:text-[1.3em]'>/</span>
                            <StepText link={"/"} className=" text-[1.2em] md:text-[1.3em] text-[#dcefd8]/[60%] " >Resources</StepText>
                            <span className='w-[2em] text-[#dcefd8]/[30%] hidden md:block text-center text-[1.2em] md:text-[1.3em]'>/</span>
                            <StepText link={"/"} className=" text-[1.2em] md:text-[1.3em] text-[#dcefd8]/[60%] " >About</StepText>
                            <span className='w-[2em] text-[#dcefd8]/[30%] hidden md:block text-center text-[1.2em] md:text-[1.3em]'>/</span>
                            <StepText link={"/"} className=" text-[1.2em] md:text-[1.3em] text-[#dcefd8]/[60%] " >Get in touch</StepText>
                        </div>
                        <div className='w-full flex items-end md:items-center h-full justify-start  md:justify-end flex-col md:flex-row gap-3 md:gap-0'>

                            <StepText link={"/"} className=" text-[1.2em] md:text-[1.3em] text-[#dcefd8]/[60%] " >Twitter</StepText>
                            <span className='w-[2em] text-[#dcefd8]/[30%] hidden md:block text-center text-[1.2em] md:text-[1.3em]'>/</span>
                            <StepText link={"/"} className=" text-[1.2em] md:text-[1.3em] text-[#dcefd8]/[60%] " >Instagram</StepText>
                            <span className='w-[2em] text-[#dcefd8]/[30%] hidden md:block text-center text-[1.2em] md:text-[1.3em]'>/</span>
                            <StepText link={"/"} className=" text-[1.2em] md:text-[1.3em] text-[#dcefd8]/[60%] " >Facebook</StepText>
