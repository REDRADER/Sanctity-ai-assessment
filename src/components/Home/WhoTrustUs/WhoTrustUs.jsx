    ...
    <section className='relative md:p-[1em_1em] z-[5] w-full'  >
      <div className='p-[1em]  bg-[--light-text] rounded-[24px] flex flex-col gap-4 relative '>
        <div className='grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-[1em]  '>
          <>
            <div className='col-span-2 p-[1.4em] h-[15em] rounded-[16px] border-2 border-[#cadcc7] '>

              <h2 className='text-[--darkest-text] text-[2.7em] font-semibold leading-[1.1]'>
                Who trusts us?
              </h2>
            </div>
            <motion.div
        ...
        <div className='  flex justify-end absolute bottom-0 right-0 cursor-pointer' onClick={() => setToggleLogos(prev => !prev)} >
          <div className='relative p-[1.2em_2em] bg-[--background]     rounded-[24px_0px_0px_0px] flex justify-center items-center '>
            ...
            <div className='group flex gap-3 items-center'>
              ...
              <h2 className='opacity-60 text-[1.2em] md:text-[1.2rem] font-medium'>
                Load More
              </h2>
            </div>
          </div>
